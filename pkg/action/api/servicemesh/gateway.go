...
// Get Gateway
func (s *serviceMeshServer) GetGateway(g *gin.Context) {
	...
	item, err := s.Gateway.Get(namespace, name)
	if err != nil {
...
// Subscribe Gateway
func (s *serviceMeshServer) ListGateway(g *gin.Context) {
	list, err := s.Gateway.List(g.Param("namespace"), "")
	if err != nil {
