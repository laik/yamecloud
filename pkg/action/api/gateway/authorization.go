...
//	//		continue
//	//	}
//	//	specNamespace, err := roleObj.Get("spec.namespaces")
//	//	if err != nil {
//	//		continue
//	//	}
//	//	if specNamespace == nil || len(specNamespace.([]interface{})) == 0 {
//	//		continue
//	//	}
//	//	for _, item := range specNamespace.([]interface{}) {
//	//		if item.(string) == namespace {
//	//			return true, nil
//	//		}
//	//	}
//	//}
