...
func (b *BaseRoleUser) Apply(namespace, name string, unstructuredExtend *service.UnstructuredExtend) (*service.UnstructuredExtend, error) {
	item, err := b.Interface.Apply(namespace, k8s.BaseRoleUser, name, unstructuredExtend)
	if err != nil {
		return nil, err
	}
	return item, nil
