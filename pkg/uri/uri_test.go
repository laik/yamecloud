...
func Test_parseOp(t *testing.T) {
	...
	expectedStructs := []expectedStruct{
		...
		{http.MethodGet, "/workload/attach/namespace/devops/pod/nginx-0-cg-0/container/nginx/common", uriStruct{Service: "workload", API: "", Resource: "pods", Namespace: "devops", Op: "attach", ResourceName: "nginx-0-cg-0"}},
